...
export default class Sound {
    ...
    // CONSTRUCTOR
    constructor() {
        this.soundLibrary = new Array<{ soundID: string; sound: HTMLAudioElement }>();
    }
    ...
    public removeSound(soundID: string) {
        this.soundLibrary.splice(this.soundLibrary.indexOf((this.getSoundElementFromLibrary(soundID) as { soundID: string, sound: HTMLAudioElement })), 1);
    }
